...
# based on https://www.mouser.com/datasheet/2/115/DGD0506A-1274585.pdf
# added solder mask parameter
# added optional indicator circle
# added ground pad
# made ground pad optional

PARTNAME = "Diodes-MSOP10"
...
Z = 5.300 # distance across outer edges of pads
G = Z - 2*1.35 # distance across inner edges of pads
...
b = 0.27 # physical pad width
L1 = (H-3.05)/2 # physical pad length

D1 = 3.05 # package width
E1 = 3.05 # package height
