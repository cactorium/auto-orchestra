...
# based on http://rohmfs.rohm.com/en/products/databook/package/soldering/discrete/surface-handa_tr.pdf
# NOTE: is missing the ground leads going out the top and bottom (sides in Rohm drawings)

# added solder mask parameter
# added optional indicator circle
# added ground plane
# added ground plane offset
# added different pad lengths
...
Z = 3.700 # distance across outer edges of pads

h1 = 0.6 # pad length for left pads
h2 = 0.45 # pad length for right pads
C = 0.65 # footprint pad spacing
w = 0.43 # footprint pad width

H = 3.4 # distance from physical pad end to opposite pad end
e = C    # physical pad spacing, same as above
b = 0.37 # physical pad width
L1 = 0.40 # physical pad length for left side
L2 = 0.45 # physical pad length for right side

D1 = 3.0 # package width
E1 = 3.3 # package height

G1 = 2.0  # ground pad width
H1 = 3.0  # ground pad height
# NOTE: custom expression
GX = Z/2-h2-G1/2 # ground pad center x
GY = 0.0 # ground pad center y
ground_pad_num = 8
