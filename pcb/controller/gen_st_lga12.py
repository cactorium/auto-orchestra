...
# Using LSM303AGR_Footprint.pdf for reference; dunno where the official documentation is
...
D1 = 2.0 # package width
E1 = 2.0 # package height

use_round_pads = False
C = 0.50 # footprint pad spacing
w = 0.3 # footprint pad width
h = 0.4 # footprint pad length

X = 1.2 + h # distance between pad centers horizontally
Y = 1.2 + h # distance between pad centers vertically

H = 2.8 # distance from physical pad end to opposite pad end horizontally
I = 2.8 # distance from physical pad end to opposite pad end vertically
e = C    # physical pad spacing, same as above
b = 0.25 # physical pad width
L1 = 0.50 # physical pad length horizontally
L2 = 0.50 # physical pad length vertically
