...
# based on https://pdfserv.maximintegrated.com/package_dwgs/21-0036.PDF
#   and https://pdfserv.maximintegrated.com/land_patterns/90-0092.PDF
...
Z = 4.30 + 1.35 # distance across outer edges of pads
G = 4.30 - 1.35 # distance across inner edges of pads
...
b = 0.305 # physical pad width
L1 = 0.950 # physical pad length
