...
# based on http://www.ti.com/lit/ds/symlink/opa2141.pdf
#   and http://www.ti.com/lit/ds/symlink/tl974.pdf
...
Z = 5.60 + 1.60 # distance across outer edges of pads
G = 5.60 - 1.60 # distance across inner edges of pads

X = (Z+G)/2. # distance between pad centers
C = 0.65 # footprint pad spacing
w = 0.35 # footprint pad width
h = (Z-G)/2. # footprint pad length

H = 6.40 # distance from physical pad end to opposite pad end
e = C    # physical pad spacing, same as above
b = 0.24 # physical pad width
L1 = (H - 4.40)/2. # physical pad length

D1 = 4.40 # package width
E1 = 5.00 # package height
