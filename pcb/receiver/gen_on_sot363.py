...
# based on https://www.mouser.com/datasheet/2/308/NLAST4599-D-66392.pdf
...
Z = 2.50 # distance across outer edges of pads
G = 2.50 - 2.*0.66 # distance across inner edges of pads
...
H = 2.10 # distance from physical pad end to opposite pad end
e = C    # physical pad spacing, same as above
b = 0.20 # physical pad width
L1 = 0.36 # physical pad length

D1 = 1.25 # package width
E1 = 2.00 # package height
