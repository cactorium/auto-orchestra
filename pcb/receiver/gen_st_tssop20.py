...
Z = 7.10 # distance across outer edges of pads
G = 4.40 # distance across inner edges of pads

X = (Z+G)/2. # distance between pad centers
C = 0.65 # footprint pad spacing
w = 0.40 # footprint pad width
h = (Z-G)/2. # footprint pad length

H = 6.400 # distance from physical pad end to opposite pad end
e = C    # physical pad spacing, same as above
b = 0.300 # physical pad width
L1 = 1.000 # physical pad length

D1 = 4.400 # package width
E1 = 6.500 # package height
