...
# Using http://www.ti.com/lit/ds/symlink/tps63700.pdf as reference
...
X = 2.8 # distance between pad centers horizontally
Y = (3.4+2.4)/2. # distance between pad centers vertically
  ...
  print("""  (pad {} smd {} (at {} {}) (size {} {}) (layers F.Cu F.Paste F.Mask)
    (solder_mask_margin {}))""".
        format(
            ...
            solder_mask_margin))
# gnd_pad, gnd_pad
bottom_pads = [ground_pad_num, ground_pad_num]
  ...
  print("""  (pad {} smd {} (at {} {}) (size {} {}) (layers F.Cu F.Paste F.Mask)
    (solder_mask_margin {}))""".
        format(
            ...
            solder_mask_margin))
# gnd_pad, gnd_pad
top_pads = [ground_pad_num, ground_pad_num]
for i in range(0, num_horiz):
  print("""  (pad {} smd {} (at {} {}) (size {} {}) (layers F.Cu F.Paste F.Mask)
    (solder_mask_margin {}))""".
        format(
