...
# based on http://ww1.microchip.com/downloads/en/appnotes/atmel-8826-seeprom-pcb-mounting-guidelines-surface-mount-packages-applicationnote.pdf
...
Z = 5.40 + 1.60 # distance across outer edges of pads
G = 5.40 - 1.60 # distance across inner edges of pads

X = (Z+G)/2. # distance between pad centers
C = 1.27 # footprint pad spacing
w = 0.60 # footprint pad width
h = (Z-G)/2. # footprint pad length

H = 6.00 # distance from physical pad end to opposite pad end
e = C    # physical pad spacing, same as above
b = 0.41 # physical pad width
L1 = (6.00 - 3.90)/2. # physical pad length

D1 = 3.90 # package width
E1 = 4.92 # package height
