...
Z = 4.93 + 1.98 # distance across outer edges of pads
G = Z - 2*1.98 # distance across inner edges of pads

X = (Z+G)/2. # distance between pad centers
C = 1.27 # footprint pad spacing
w = 0.53 # footprint pad width
...
L1 = 0.83 # physical pad length

D1 = 3.90 # package width
E1 = 4.90 # package height
