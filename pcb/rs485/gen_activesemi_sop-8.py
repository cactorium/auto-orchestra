...
# based on http://rohmfs.rohm.com/en/techdata_basic/ic/package/sop8_1-e.pdf
# added solder mask parameter
# added optional indicator circle
# added ground pad
# made ground pad optional

PARTNAME = "ActiveSemi-SOP8"
...
Z = 4.6 + 1.1*2 # distance across outer edges of pads
G = Z - 2*1.1 # distance across inner edges of pads

X = (Z+G)/2. # distance between pad centers
C = 1.27 # footprint pad spacing
w = 0.76 # footprint pad width
h = (Z-G)/2. # footprint pad length

H = 6.05 # distance from physical pad end to opposite pad end
e = C    # physical pad spacing, same as above
b = 0.42 # physical pad width
L1 = 0.835 # physical pad length

D1 = 3.90 # package width
E1 = 4.89 # package height

has_ground_pad = False
G1 = 2.700  # ground pad width
H1 = 3.600  # ground pad height
ground_pad_num = 11
